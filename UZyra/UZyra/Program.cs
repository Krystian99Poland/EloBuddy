...
namespace UZyra
{
    class Program
    {
        ...
        private static void Loading_OnLoadingComplete(EventArgs args)
        {
            ...
            // Menu
            Menu = MainMenu.AddMenu("UZyra", "UZyra");
            Menu.AddGroupLabel("UZyra V0.2");

            Menu.AddSeparator();

            Menu.AddLabel("Made by Krystian (RekoForest)");
           ...
           // SkillMenu.Add("rslider", new Slider("Minimum people for R", 1, 0, 5));
            ...
            Chat.Print("UZyra loaded Gl & Hf ", System.Drawing.Color.Green);
